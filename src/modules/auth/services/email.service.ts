  ...
  async sendConfirmationEmail(
    ...
    const mailOptions: nodemailer.SendMailOptions = {
      ...
      html: `
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background-color: #fff; padding: 20px; border-radius: 5px; border: 1px solid #ddd;">
            ...
            <p>Благодарим вас за регистрацию в системе финансового аналитика.</p>
          ...
          <div style="margin-top: 20px; text-align: center; font-size: 12px; color: #7f8c8d;">
            <p>© ${new Date().getFullYear()} Система финансового аналитика. Все права защищены.</p>
          </div>
        </body>
        </html>
      `,
      text: `
        ...
        Благодарим вас за регистрацию в системе финансового аналитика.
        ...
        © ${new Date().getFullYear()} Система финансового аналитика. Все права защищены.
      `,
    };
